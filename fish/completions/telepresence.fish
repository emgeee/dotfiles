...
function __telepresence_prepare_completions
    ...
    set -l results (__telepresence_perform_completion)
    __telepresence_debug "Completion results: $results"
    ...
    set --global __telepresence_comp_results $results[1..-2]
...
complete -c telepresence -n '__telepresence_prepare_completions' -f -a '$__telepresence_comp_results'
